...
#include "opencv2/musabgsegm.hpp"
...
int main(int argc, const char** argv)
{
    ...
    Ptr<BackgroundSubtractor> mog = musa::createBackgroundSubtractorMOG();
    Ptr<BackgroundSubtractor> mog2 = musa::createBackgroundSubtractorMOG2();
