...
int main(int argc, const char* argv[])
{
    ...
    if (!full)
    {
        Ptr<GeneralizedHoughBallard> ballard = useGpu ? musa::createGeneralizedHoughBallard() : createGeneralizedHoughBallard();
    ...
    {
        Ptr<GeneralizedHoughGuil> guil = useGpu ? musa::createGeneralizedHoughGuil() : createGeneralizedHoughGuil();
    ...
    if (useGpu)
    {
        musa::GpuMat d_templ(templ);
        musa::GpuMat d_image(image);
        musa::GpuMat d_position;
