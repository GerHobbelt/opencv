...
static void help()
{
    cout << "\nThis program demonstrates using SURF_MUSA features detector, descriptor extractor and BruteForceMatcher_MUSA" << endl;
...
int main(int argc, char* argv[])
{
    ...
    Ptr<cv::musa::DescriptorMatcher> matcher = cv::musa::DescriptorMatcher::createBFMatcher(surf.defaultNorm());
