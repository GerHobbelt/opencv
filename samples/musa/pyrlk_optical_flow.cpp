...
int main(int argc, const char* argv[])
{
    ...
    Ptr<musa::CornersDetector> detector = musa::createGoodFeaturesToTrackDetector(d_frame0Gray.type(), points, 0.01, minDist);
    ...
    {
        // Sparse
        Ptr<musa::SparsePyrLKOpticalFlow> d_pyrLK_sparse = musa::SparsePyrLKOpticalFlow::create(
    ...
    {
        // Dense
        Ptr<musa::DensePyrLKOpticalFlow> d_pyrLK_dense = musa::DensePyrLKOpticalFlow::create(
            Size(winSize, winSize), maxLevel, iters);
