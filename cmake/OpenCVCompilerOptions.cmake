  ...
  if(CCACHE_PROGRAM)
    ...
    foreach(LANG C CXX CUDA)
      if(DEFINED CMAKE_${LANG}_COMPILER_LAUNCHER)
        set(__OLD_CMAKE_${LANG}_COMPILER_LAUNCHER CMAKE_${LANG}_COMPILER_LAUNCHER)
      else()
        set(__OLD_CMAKE_${LANG}_COMPILER_LAUNCHER "")
      endif()
    endforeach()
    ...
    elseif(__OLD_RULE_LAUNCH_COMPILE)
      ...
      endforeach()
      find_host_program(CACHEBUILDER_PROGRAM cachebuilder)
      if(CACHEBUILDER_PROGRAM)
        foreach(LANG C CXX)
          message(STATUS "Enabling cachebuilder for ${LANG}")
          set(CMAKE_${LANG}_COMPILER_LAUNCHER ${CACHEBUILDER_PROGRAM} CACHE STRING "")
        endforeach()
      ...
      if(IS_CCACHE_WORKS)
        ...
        foreach(LANG C CXX CUDA)
          set(CMAKE_${LANG}_COMPILER_LAUNCHER __OLD_CMAKE_${LANG}_COMPILER_LAUNCHER)
        endforeach()
      endif()
    endif()
  else()
