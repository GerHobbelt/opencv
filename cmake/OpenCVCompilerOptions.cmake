...
if(ENABLE_CCACHE AND NOT OPENCV_COMPILER_IS_CCACHE)
  ...
  if(CCACHE_PROGRAM)
    ...
    elseif(__OLD_RULE_LAUNCH_COMPILE)
      ...
      endforeach()
      find_host_program(BUILDCACHE_PROGRAM buildcache)
      if(BUILDCACHE_PROGRAM)
        foreach(LANG C CXX)
          message(STATUS "Enabling buildcache for ${LANG}")
          set(CMAKE_${LANG}_COMPILER_LAUNCHER ${BUILDCACHE_PROGRAM} CACHE STRING "")
        endforeach()
      endif()
