...
{
    std::string model_path = "/home/test_user01/fytao/opencv_zoo/models/text_recognition_crnn/crnn_ch.sim.onnx";
    auto net = readNet(model_path);
    net.setPreferableBackend(DNN_BACKEND_CANN);
...
{
    std::string model_path = "/home/test_user01/fytao/opencv_zoo/models/text_recognition_crnn/crnn_cn.sim.onnx";
    auto net = readNet(model_path);
    net.setPreferableBackend(DNN_BACKEND_CANN);
...
{
    std::string model_path = "/home/test_user01/fytao/opencv_zoo/models/text_recognition_crnn/crnn_en.sim.onnx";
    auto net = readNet(model_path);
    net.setPreferableBackend(DNN_BACKEND_CANN);
